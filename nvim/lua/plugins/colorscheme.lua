return {
	...
	--	-- configure lazy to use nord theme
	{
		...
		config = function()
			...
			vim.api.nvim_set_hl(0, "NavicIconsModule", { default = false, bg = "#3b4252", fg = "#d8dee9" })
			vim.api.nvim_set_hl(0, "NavicIconsNamespace", { default = false, bg = "#3b4252", fg = "#d8dee9" })
			vim.api.nvim_set_hl(0, "NavicIconsPackage", { default = false, bg = "#3b4252", fg = "#d8dee9" })
			...
			vim.api.nvim_set_hl(0, "NavicIconsProperty", { default = false, bg = "#3b4252", fg = "#d8dee9" })
			vim.api.nvim_set_hl(0, "NavicIconsField", { default = false, bg = "#3b4252", fg = "#d8dee9" })
			...
			vim.api.nvim_set_hl(0, "NavicIconsVariable", { default = false, bg = "#3b4252", fg = "#d8dee9" })
			...
			vim.api.nvim_set_hl(0, "NavicIconsEnumMember", { default = false, bg = "#3b4252", fg = "#d8dee9" })
			...
			vim.api.nvim_set_hl(0, "NavicSeparator", { default = false, bg = "#3b4252", fg = "#d8dee9" })
		end,
	},
}
